...
## V3 TTS Provider configuration

- CloudBase production should use Tencent Cloud TTS with `TTS_PROVIDER=tencent`.
- gTTS remains available only as an explicit local provider with `TTS_PROVIDER=gtts`.
